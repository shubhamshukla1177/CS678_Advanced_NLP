...
class BertSentClassifier(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        self.cls_lyr = torch.nn.Linear(config.hidden_size, self.num_labels)
